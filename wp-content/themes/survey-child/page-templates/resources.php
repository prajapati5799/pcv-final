...
<script>
    ...
    jQuery(function() {
        $('#data-category-filter-select').on('change', function() {
            ...
            // else if (window.location.href.indexOf(category_slug) != category_slug ) {
            //     echo 'hello';
            // }
            else {
                // window.location.href = window.location.href + "?cat-by=" + category_slug;
                ...
                if (catby != 0) {
                    // window.location.href = window.location.href + "?cat-by=" + category_slug;
                    // alert('hkh');
                    var newu1 = replaceUrlParam(window.location.href, "cat-by", category_slug);
                    //    alert(newu1);
                    window.location.href = replaceUrlParam(newu1, "cat-by", category_slug)
                    window.location.href = replaceUrlParam(newu1, "subcat-by", 0)
                } 
                 else if (subpar != 0) {
