...
// return '<div class="digit-total ">
//         <span id="count1">8</span>
//         <span id="count2">4</span>
//         <span id="count3">3</span>
//         <span id="count4">7</span>
//         <span id="count5">0</span>
//         <span id="count6">0</span>
//         <span id="count7">0</span>
// 		<span id="count8">0</span>
//     </div>'; 
// }
//TOTAL DOSES PVC ADMINISTERED
function total_doses()
{
  $totald = get_field('total_doses');
...
function get_term_children_drc( $term_slug ) {
