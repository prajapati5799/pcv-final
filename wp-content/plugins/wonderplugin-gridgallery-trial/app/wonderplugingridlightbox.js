...
function loadWPGridHtml5LightBox(jsFolder) {
    (function($) {
        $.fn.wonderplugingridlightbox = function(options) {
            ...
            if (inst.options.limitfocus) {
                ...
                $(window).on("html5lightbox.lightboxclosed",
                    function() {
            ...
            inst.readNodeData = function(node, parentNode) {
                ...
                for (var i = 0; i < inst.elemArray.length; i++)
                    if (node.attr("href") == inst.elemArray[i][ELEM_HREF]) {
                        ...
                        return
                    } var w = inst.checkParentClass(node,
                    parentNode, "width");
                ...
                var newItem = new Array(fileType, node.attr("href"), title, group, w, h, inst.checkParentData(node, parentNode, "webm"), inst.checkParentData(node, parentNode, "ogg"), inst.checkParentData(node, parentNode,
                    "thumbnail"), inst.checkParentData(node, parentNode, "description"), null, null, null, inst.checkParentData(node, parentNode, "socialmedia"), inst.checkParentData(node, parentNode, "weblink"), inst.checkParentData(node, parentNode, "weblinktarget"), inst.checkParentData(node, parentNode, "weblinktext"), mediumw, mediumh, smallw, smallh);
            ...
            inst.createMarkup = function() {
                ...
                styleCss += " #gridgallery-html5-lightbox .html5-error {" +
                ...
                if (inst.options.titlestyle == "right") {
                    ...
                    styleCss += "#gridgallery-html5-lightbox .html5-elem-wrap {height:100%;} #gridgallery-html5-lightbox .html5-elem-data-box {width:" +
            ...
            inst.showSocialButtons = function() {
                if (inst.options.showsocial) {
                    ...
                    if (inst.options.showemail) socialCode += '<div class="html5-social-btn html5-social-btn-action html5-social-email" style="' + socialBtnCSS + '"><div class="mh-icon-mail' +
                        (inst.options.socialrotateeffect ? " html5-rotate" : "") + '" style="' + socialCSS + 'background-color:#4d83ff;"></div></div>';
                    ...
                    $(".html5-social-btn-action", inst.$lightbox).click(function() {
                        var shareUrl = inst.options.sharemediaurl ? inst.currentElem[ELEM_HREF] : window.location.href + (window.location.href.indexOf("?") < 0 ? "?" : "&") + "wpgridlightboxshare=" + encodeURIComponent(inst.currentElem[ELEM_HREF]);
            ...
            inst.initAudio = function() {
                ...
                var audioCode = '<div class="html5-audio"><audio' + (inst.options.audioautoplay ? " autoplay" : "") + (inst.options.audioloop ? " loop" : "") + '><source src="' + inst.options.audiofile + '" type="audio/mpeg"></audio></div>';
            ...
            inst.showNavigation = function() {
                ...
                $("body").append("<div id='gridgallery-html5-lightbox-nav' class='html5-nav' style='display:block;position:" + posType + ";" + posCss + "width:100%;height:" + inst.options.navheight + "px;z-index:9999999;" + (inst.options.navbgcolor ? "background-color:" + inst.options.navbgcolor + ";" : "") + "'>" + "<div class='html5-nav-container' style='position:relative;margin:" +
            ...
            inst.showPDF = function(elem) {
                ...
                else if (inst.options.isAndroid ||
            ...
            inst.finishDone = function() {
                ...
                $("head").find("style").each(function() {
                    if ($(this).data("creator") ==
                        "gridgallery-html5-lightbox") $(this).remove()
                });
            ...
            inst.embedHTML5Video = function($container, src, autoplay,
                ...
                if (!inst.options.nativehtml5controls && !inst.options.videohidecontrols) {
                    ...
                    $("video", $container).wpGridLightboxHTML5VideoControls(inst.options.skinsfolder,
    ...
    (function($) {
        $.fn.wpGridLightboxHTML5VideoControls = function(skinFolder, parentInst, videoElem, hideControls, hidePlayButton, defaultVolume, fullscreenNativeControls, html5VideoNoDownload, skinImages, showsubtitle, vttline, showsubtitlebydefault) {
