...
== Whats in PRO? ==
<blockquote>
1. MULTIPLE TAXONOMIES FILTER
2. Overwrite Layout in Your theme's folder.
3. 5+ More Post Layouts.
4. Multiple Checkbox Filter Layout.
5. Support Multiple Section on same page.
6. Sort Posts Settings.
7. Load More Posts added in Pagination.
8. Google Fonts List Added.
9. 40+ Animation effects added for Post Layouts.
10. More button added for Default Filter Layout (Helps when number of    categories to show).
11. More Filter/Action Hooks for developers.
12. 1 On Demand Layout For new user.
13. One Click Demo Preview Import.
14. Search Field Added to search through posts.
15. New Tabs Filter Layout Added.
16. Translation settings to change default strings.
17. Select Default Category/Term on first page load.
18. Enable/Disable Scroll (Added in 6.0)
18. Many More Features Added.
</blockquote>
...
[youtube https://www.youtube.com/watch?v=V0JUYdaFcOw]
