	...
	<form class="lrm-form" action="#0" data-action="login">
        <div class="lrm-fieldset-wrap">
            ...
            <div class="fieldset">
                ...
                <label class="form-label"><?= $username_label; ?></label>
                <label class="image-replace lrm-email lrm-ficon-mail" title="<?= $username_label; ?>"></label>
                <input name="username" class="full-width has-padding has-border" type="text" aria-label="<?= $username_label; ?>" placeholder="" <?= $fields_required; ?> value="" autocomplete="username" data-autofocus="1">
                <span class="lrm-error-message"></span>
            </div>

            <div class="fieldset">
                <?php $pass_label = esc_attr( lrm_setting('messages/login/password', true) ); ?>
                <label class="form-label"><?= $pass_label; ?></label>
                <label class="image-replace lrm-password lrm-ficon-key" title="<?= $pass_label; ?>"></label>
                <input name="password" class="full-width has-padding has-border" type="password" aria-label="<?= $pass_label; ?>" placeholder="" <?= $fields_required; ?> value="">
                <span class="lrm-error-message"></span>
