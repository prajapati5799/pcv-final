		...
		public function builder7_top_menu(){
				...
				$output .= '<div class="nav-content prime-menu">';
						...
						$output.= '<div class="top-menu-dropdown"><ul class="tabs_nf sec-menu aa_menu"> 
										...
										'.(($theme->Name=='NEX-Forms Demo') ? '<li class="tab demo-menu-item"><a href="#test-page" data-link="http://basixonline.net/nex-forms-admin-demo/nex-forms-demo-form/user-test-form-'.$_GET['open_form'].'/?form_id='.$_GET['open_form'].'" class="save_nex_form demo_save"><span class="top-icon fas fa-external-link-alt"></span><span class="menu-text">Demo Test Page</span></a></li>' : '' ).'
