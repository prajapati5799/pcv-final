...
/* UPDATE */
	...
	public function print_paypal_setup($form_Id){
		...
		$output .= '<div class="paypal_setup" >';
								...
								$output .=  '<div class="row">';
									$output .= '<div class="integration_form_label ">Currency</div><div class="integration_form_field zero_padding tour_paypal_setup_5"><select name="currency_code" class="form-control" data-selected="'.$form->currency_code.'">
...
/* DELETE */
		public function delete_record(){
			...
			// Update record while delete any records
			$wpdb->query("UPDATE " . NEX_FORM_TEMP_ENTRY_TBL . " SET form_data = '[]', files_data = '[]', is_published = '0', state_status = '0', record_id = '0'  WHERE record_id = '".filter_var($record_id,FILTER_SANITIZE_NUMBER_INT)."'");
			die();
		}	
