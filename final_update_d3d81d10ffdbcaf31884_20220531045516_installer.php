...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = 'final_update_d3d81d10ffdbcaf31884_20220531045516_archive.zip';
	const ARCHIVE_SIZE		 = '458242781';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = 'd3d81d1-31045516';
    const SECONDARY_PACKAGE_HASH = 'be831b7-31045516';
	const VERSION			 = '1.4.5';
